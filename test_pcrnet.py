...
def options():
	...
	parser.add_argument('--dataset_path', type=str, default='/Users/nanzhang/PythonProject/dataset/ModelNet40',
	...
	parser.add_argument('--pretrained', default='pcrnet/pretrained/exp_ipcrnet_v1/models/best_model.t7', type=str,
...
def main():
	...
	args = options()
	testset = RegistrationData('PCRNet', ModelNet40Data(train=False,num_points=args.num_points), is_testing=True)
